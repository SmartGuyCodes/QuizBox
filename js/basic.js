...
function update_check(sq_version){
	...
	$.ajax({
		...
		success: function(data){
			...
			var msg="<div class='alert alert-success'>You are using updated version of <a href='http://quizbox.trucomm.co.ke'>QuizBox "+sq_version+"</a></div>";	
			}else{
			var msg="<div class='alert alert-danger'>New version available: QuizBox v"+data.trim()+". You are using outdated version of QuizBox v"+sq_version+". Visit <a href='http://quizbox.trucomm.co.ke'>www.quizbox.trucomm.co.ke</a> to download</div>";	
