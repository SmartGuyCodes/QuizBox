...
--
-- Table structure for table `quizboxquiz_custom_form`
--

CREATE TABLE `quizboxquiz_custom_form` (
...
--
-- Table structure for table `quizboxquiz_setting`
--

CREATE TABLE `quizboxquiz_setting` (
...
--
-- Dumping data for table `quizboxquiz_setting`
--

INSERT INTO `quizboxquiz_setting` (`setting_id`, `setting_name`, `setting_value`, `setting_group_name`, `order_by`, `setting_description`) VALUES
...
(35, 'Master_password', 'quizboxquiz', 'General', 1, NULL),
...
--
-- Table structure for table `quizbox_add`
--

CREATE TABLE `quizbox_add` (
...
--
-- Dumping data for table `quizbox_add`
--

INSERT INTO `quizbox_add` (`add_id`, `advertisement_code`, `banner`, `banner_link`, `position`, `add_status`) VALUES
(1, '', '1501084226.jpg', 'https://quizboxquiz.com', 'Top', 'Inactive'),
(2, '	', '1501084206.jpg', 'https://quizboxquiz.com', 'Bottom', 'Active'),
(3, '', '1501084197.jpg', 'https://quizboxquiz.com', 'Center_Result', 'Active'),
(4, '', '1501084258.jpg', 'https://quizboxquiz.com', 'During_Quiz', 'Active');

-- --------------------------------------------------------

--
-- Table structure for table `quizbox_answers`
--

CREATE TABLE `quizbox_answers` (
  `aid` int(11) NOT NULL,
  `qid` int(11) NOT NULL,
...
--
-- Dumping data for table `quizbox_answers`
--

INSERT INTO `quizbox_answers` (`aid`, `qid`, `q_option`, `uid`, `score_u`, `rid`, `qn`) VALUES
(8, 79, '300', 1, 1, 1, 0),
(9, 80, '304', 1, 1, 1, 0),
(10, 81, '317', 1, 0.5, 1, 0),
(11, 81, '319', 1, 0.5, 1, 0),
...
--
-- Table structure for table `quizbox_category`
--

CREATE TABLE `quizbox_category` (
  `cid` int(11) NOT NULL,
  `category_name` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `quizbox_category`
--

INSERT INTO `quizbox_category` (`cid`, `category_name`) VALUES
(1, 'General knowledge'),
(2, 'Math');
...
--
-- Table structure for table `quizbox_group`
--

CREATE TABLE `quizbox_group` (
  `gid` int(11) NOT NULL,
...
--
-- Dumping data for table `quizbox_group`
--

INSERT INTO `quizbox_group` (`gid`, `group_name`, `price`, `valid_for_days`, `description`) VALUES
...
--
-- Table structure for table `quizbox_level`
--

CREATE TABLE `quizbox_level` (
  `lid` int(11) NOT NULL,
  `level_name` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `quizbox_level`
--

INSERT INTO `quizbox_level` (`lid`, `level_name`) VALUES
(1, 'Easy'),
(2, 'Difficult');
...
--
-- Table structure for table `quizbox_notification`
--

CREATE TABLE `quizbox_notification` (
  `nid` int(11) NOT NULL,
...
--
-- Dumping data for table `quizbox_notification`
--

INSERT INTO `quizbox_notification` (`nid`, `notification_date`, `title`, `message`, `click_action`, `notification_to`, `response`, `uid`, `viewed`) VALUES
(1, '2019-03-18 06:20:37', 'Developer', 'test', 'http://localhost/quizboxquiz_v5/', '/topics/quizboxQuiz', '<HTML>\n<HEAD>\n<TITLE>Invalid (legacy) Server-key delivered or Sender is not authorized to perform request.</TITLE>\n</HEAD>\n<BODY BGCOLOR=\"#FFFFFF\" TEXT=\"#000000\">\n<H1>Invalid (legacy) Server-key delivered or Sender is not authorized to perform request.</H1>\n<H2>Error 401</H2>\n</BODY>\n</HTML>\n', 0, 0),
(2, '2019-03-18 12:41:51', 'Developer', 'Helllo', 'http://localhost/quizboxquiz_v5/', '/topics/quizboxQuiz', '<HTML>\n<HEAD>\n<TITLE>Invalid (legacy) Server-key delivered or Sender is not authorized to perform request.</TITLE>\n</HEAD>\n<BODY BGCOLOR=\"#FFFFFF\" TEXT=\"#000000\">\n<H1>Invalid (legacy) Server-key delivered or Sender is not authorized to perform request.</H1>\n<H2>Error 401</H2>\n</BODY>\n</HTML>\n', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `quizbox_options`
--

CREATE TABLE `quizbox_options` (
  `oid` int(11) NOT NULL,
  `qid` int(11) NOT NULL,
  `q_option` text NOT NULL,
...
--
-- Dumping data for table `quizbox_options`
--

INSERT INTO `quizbox_options` (`oid`, `qid`, `q_option`, `q_option_match`, `q_option1`, `score`, `q_option_match1`) VALUES
...
--
-- Table structure for table `quizbox_payment`
--

CREATE TABLE `quizbox_payment` (
  `pid` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
  `gid` int(11) NOT NULL,
...
--
-- Dumping data for table `quizbox_payment`
--

INSERT INTO `quizbox_payment` (`pid`, `uid`, `gid`, `quid`, `amount`, `paid_date`, `payment_gateway`, `payment_status`, `transaction_id`, `other_data`) VALUES
(1, 10, 3, 0, 100, 0, 'Paypal', 'Paid', '1233423DCFDFD', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `quizbox_qbank`
--

CREATE TABLE `quizbox_qbank` (
  `qid` int(11) NOT NULL,
...
--
-- Dumping data for table `quizbox_qbank`
--

INSERT INTO `quizbox_qbank` (`qid`, `question_type`, `question`, `description`, `question1`, `description1`, `cid`, `lid`, `no_time_served`, `no_time_corrected`, `no_time_incorrected`, `no_time_unattempted`, `inserted_by`, `inserted_by_name`, `paragraph`, `paragraph1`, `parent_id`) VALUES
...
(82, 'Multiple Choice Single Answer', ' Who is in the picture?<img src=&#34;http://localhost/quizboxquiz_v4.0_enterprise/upload/word_images/15090303561.jpeg&#34;>', '  ', NULL, NULL, 1, 1, 0, 0, 0, 0, 0, NULL, NULL, NULL, 0),
...
(114, 'Multiple Choice Single Answer', ' Who is in the picture?<img src=&#34;http://localhost/quizboxquiz_v4.0_enterprise/upload/word_images/15091000591.jpeg&#34;>', '  ', NULL, NULL, 2, 1, 0, 0, 0, 0, 0, NULL, '', NULL, 0),
...
(118, 'Multiple Choice Single Answer', '<p>Who is in the picture?<img src=\"../../../../quizboxquiz_v4.0_enterprise/upload/word_images/15091002001.jpeg\" /></p>', '', NULL, NULL, 2, 1, 2, 0, 0, 2, 0, NULL, NULL, NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `quizbox_qcl`
--

CREATE TABLE `quizbox_qcl` (
...
--
-- Dumping data for table `quizbox_qcl`
--

INSERT INTO `quizbox_qcl` (`qcl_id`, `quid`, `cid`, `lid`, `noq`, `i_correct`, `i_incorrect`) VALUES
(80, 2, 1, 1, 3, '1', '0'),
(81, 2, 0, 1, 1, '1', '0'),
(82, 2, 2, 1, 1, '1', '0');
...
--
-- Table structure for table `quizbox_quiz`
--

CREATE TABLE `quizbox_quiz` (
  `quid` int(11) NOT NULL,
...
--
-- Dumping data for table `quizbox_quiz`
--

INSERT INTO `quizbox_quiz` (`quid`, `quiz_name`, `description`, `start_date`, `end_date`, `gids`, `qids`, `noq`, `correct_score`, `incorrect_score`, `ip_address`, `duration`, `maximum_attempts`, `pass_percentage`, `view_answer`, `camera_req`, `question_selection`, `gen_certificate`, `certificate_text`, `with_login`, `quiz_template`, `uids`, `inserted_by`, `inserted_by_name`, `show_chart_rank`, `quiz_price`) VALUES
...
--
-- Table structure for table `quizbox_result`
--

CREATE TABLE `quizbox_result` (
  `rid` int(11) NOT NULL,
  `quid` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
...
--
-- Dumping data for table `quizbox_result`
--

INSERT INTO `quizbox_result` (`rid`, `quid`, `uid`, `result_status`, `start_time`, `end_time`, `categories`, `category_range`, `r_qids`, `individual_time`, `total_time`, `score_obtained`, `percentage_obtained`, `attempted_ip`, `score_individual`, `photo`, `manual_valuation`) VALUES
...
--
-- Table structure for table `quizbox_users`
--

CREATE TABLE `quizbox_users` (
  `uid` int(11) NOT NULL,
...
--
-- Dumping data for table `quizbox_users`
--

INSERT INTO `quizbox_users` (`uid`, `password`, `email`, `first_name`, `last_name`, `contact_no`, `connection_key`, `gid`, `su`, `inserted_by`, `subscription_expired`, `verify_code`, `wp_user`, `registered_date`, `photo`, `user_status`, `web_token`, `android_token`, `skype_id`, `time_zone`) VALUES
...
(12, 'e10adc3949ba59abbe56e057f20f883e', 'contact234@quizbox.info', 'sandhu', 'laddi', '1234567890', NULL, '1', 2, 0, 0, 6023, NULL, '2019-05-14 07:35:12', NULL, 'Active', NULL, NULL, NULL, 'Asia/Kolkata'),
...
--
-- Table structure for table `quizbox_users_custom`
--

CREATE TABLE `quizbox_users_custom` (
...
--
-- Dumping data for table `quizbox_users_custom`
--

INSERT INTO `quizbox_users_custom` (`c_id`, `field_id`, `uid`, `field_values`) VALUES
(10, 3, 5, '1234567890'),
(17, 1, 9, 'DAV'),
(18, 2, 9, '8529637410'),
(19, 3, 9, '1234567890');
...
--
-- Indexes for table `quizboxquiz_custom_form`
--
ALTER TABLE `quizboxquiz_custom_form`
  ADD PRIMARY KEY (`field_id`);

--
-- Indexes for table `quizboxquiz_setting`
--
ALTER TABLE `quizboxquiz_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indexes for table `quizbox_add`
--
ALTER TABLE `quizbox_add`
  ADD PRIMARY KEY (`add_id`);

--
-- Indexes for table `quizbox_answers`
--
ALTER TABLE `quizbox_answers`
  ADD PRIMARY KEY (`aid`);

--
-- Indexes for table `quizbox_category`
--
ALTER TABLE `quizbox_category`
  ADD PRIMARY KEY (`cid`);

--
-- Indexes for table `quizbox_group`
--
ALTER TABLE `quizbox_group`
  ADD PRIMARY KEY (`gid`);

--
-- Indexes for table `quizbox_level`
--
ALTER TABLE `quizbox_level`
  ADD PRIMARY KEY (`lid`);

--
-- Indexes for table `quizbox_notification`
--
ALTER TABLE `quizbox_notification`
  ADD PRIMARY KEY (`nid`);

--
-- Indexes for table `quizbox_options`
--
ALTER TABLE `quizbox_options`
  ADD PRIMARY KEY (`oid`);

--
-- Indexes for table `quizbox_payment`
--
ALTER TABLE `quizbox_payment`
  ADD PRIMARY KEY (`pid`);

--
-- Indexes for table `quizbox_qbank`
--
ALTER TABLE `quizbox_qbank`
  ADD PRIMARY KEY (`qid`);

--
-- Indexes for table `quizbox_qcl`
--
ALTER TABLE `quizbox_qcl`
  ADD PRIMARY KEY (`qcl_id`);

--
-- Indexes for table `quizbox_quiz`
--
ALTER TABLE `quizbox_quiz`
  ADD PRIMARY KEY (`quid`);

--
-- Indexes for table `quizbox_result`
--
ALTER TABLE `quizbox_result`
  ADD PRIMARY KEY (`rid`);

--
-- Indexes for table `quizbox_users`
--
ALTER TABLE `quizbox_users`
  ADD PRIMARY KEY (`uid`);

--
-- Indexes for table `quizbox_users_custom`
--
ALTER TABLE `quizbox_users_custom`
