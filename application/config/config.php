...
$config['encryption_key'] = 'e3b0c44298fc1c149afbf4c8996fb92427aeiou4649b934ca495991b7852b855';
...
$sql = " select * from quizboxquiz_setting";
$result_config = $conn->query($sql);
// echo "<pre>"; print_r($result_config); die;
$csetting=array();
