<html lang="en">
 ...
 <body id="page-top">
     ...
     <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
       ...
       <!-- Sidebar - Brand -->
       <a class="sidebar-brand d-flex align-items-center justify-content-center" href="https://quizbox.trucomm.co.ke">
          <div class="sidebar-brand-text mx-3"><?php if($hres[0]['setting_value']==""){ ?>CmsAfrica.Academy<sup>1.0</sup><?php }else{ echo $hres[0]['setting_value']; }?> </div>
		</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseSupport" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="https://trucomm.co.ke" target="_blank">Support</a>
          </div>
        </div>
      </li>
...
$logged_in=$this->session->userdata('logged_in');
	...
	join quizbox_users on quizbox_users.uid=appointment_request.request_by 
	 where appointment_request.to_id='$uid' and appointment_request.appointment_status='Pending' ");
	$invitations=$query->result_array();
	
 	$query=$this->db->query("select * from quizbox_notification 
	  where (quizbox_notification.uid='$uid' OR quizbox_notification.uid='0') AND (quizbox_notification.viewed='0')  ");
