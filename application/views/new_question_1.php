...
<div class="col-lg-6">
			<div class="form-group">	 
					...
					Go to 'My_Quiz_Box_Folder*/editor/plugins/jbimages/' Open config.php. at line number 41 update <b>quizbox_v1_enterprise</b> with <b>My_Quiz_Box_Folder</b><br>
					Note: Here My_Quiz_Box_Folder is the folder name where you installed/uploaded savsoft quiz files. if its done in root folder of domain then remove 'quizbox_v1_enterprise/' from path.
					</div>
