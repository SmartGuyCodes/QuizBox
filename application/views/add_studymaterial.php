 <div class="container">
 	<h3><?php echo $title;?></h3>
   	<div class="row">
   		<?php echo form_open('study_material/add_new_studymaterial', array('enctype'=>'multipart/form-data')); ?>
					...
					<div class="panel-body"> 
							...
							<select name="cid" class="form-control">
								<option value="0">--Select--</option>
									<?php foreach($categories as $cates){ ?>
										<option value="<?php echo $cates['cid']; ?>">
											<?php echo $cates['category_name']; ?>
										</option>
									<?php } ?>
							</select>	
						</div>
						...
						<div class="form-group">	
							...
							<?php foreach($groups as $group){ ?>
								<input type="checkbox"   name="gid[]"   value="<?php echo $group['gid']; ?>"  > 	
