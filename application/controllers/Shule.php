...
class Shule extends CI_Controller {
	 ...
	 function dd($data = null){
	     ...
	     echo'<pre>HTTP Resp/Req: ';print_r($_REQUEST);
	...
	public function index()
	{
		...
		$data['title']=$this->lang->line('quizbox');
		$data['recent_quiz']=$this->quiz_model->recent_quiz('5');
		$data['study_material'] = $this->studymaterial_model->getLandingMaterial();
	...
	public function view(){
	    ...
	    $data['content'] = $this->studymaterial_model->getSingleMaterial($data['id']);
	    
	   // $this->dd($data);
	   
	   $this->load->view('shulecontent');
	}
